...
add_action( 'vc_before_init', 'hm_ebook_form_vc' );
function hm_ebook_form_vc() {
    if (function_exists('vc_map')) {
        vc_map(array(
            "name" => __("HelloMaaS download e-Book form", "hellomaas"),
            "base" => "hm_ebook_form",
            "class" => "",
            "category" => __("Content"),
            "params" => array(
...
// Add shortcode
add_shortcode( 'hm_ebook_form', 'hm_ebook_form_callback' );
function hm_ebook_form_callback( $atts ) {
...
#_form_18_ { font-size:14px; line-height:1.6; font-family:arial, helvetica, sans-serif; margin:0; }
 ...
 #_form_18_ input[type="text"],#_form_18_ input[type="date"],#_form_18_ textarea { padding:6px; height:auto; border:#979797 1px solid; border-radius:4px; color:#000 !important; font-size:13px; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; }
 #_form_18_ textarea { resize:none; }
 #_form_18_ ._submit { -webkit-appearance:none; cursor:pointer; text-align:center; background:#2e2727 !important; border:0 !important; -moz-border-radius:60px !important; -webkit-border-radius:60px !important; border-radius:60px !important; color:#fff !important; padding:10px !important; }
 ...
 #_form_18_ ._form_element input[type="text"],#_form_18_ ._form_element input[type="date"],#_form_18_ ._form_element select,#_form_18_ ._form_element textarea:not(.g-recaptcha-response) { display:block; width:100%; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; }
 ...
 #_form_18_ ._error { display:block; position:absolute; font-size:13px; z-index:10000001; }
 ...
 #_form_18_ ._error-inner { padding:8px 12px; background-color:#f37c7b; font-size:13px; font-family:arial, sans-serif; color:#fff; text-align:center; text-decoration:none; -webkit-border-radius:4px; -moz-border-radius:4px; border-radius:4px; }
 ...
 #_form_18_ { position:relative; text-align:left; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; *zoom:1; background:transparent !important; border:0px solid #ff9e30 !important; -moz-border-radius:9px !important; -webkit-border-radius:9px !important; border-radius:9px !important; }
 ...
 #_form_18_ ._x75754058 ._form-title { font-size:36px; line-height:48px; font-weight:500; }
 #_form_18_ ._x41812516 { font-size:18px !important; color:#5b6889; }
 #_form_18_ ._submit { text-transform:uppercase; color:#fff; font-size:15px; font-weight:600; font-weight:600; display:inline-block; min-width:298px; padding:0 25px !important; height:58px; line-height:58px; text-align:center; background-image:linear-gradient(105deg, #ff8400, #f8765e) !important; border-radius:30px; letter-spacing:1px; }
 #_form_18_ ._submit:hover { background-image:none !important; background-color:#3a404f !important; }
</style>
<form method="POST" action="https://hellomaas.activehosted.com/proc.php" id="_form_18_" class="_form _form_18 _inline-form  _dark" novalidate>
  ...
  <div class="_form-content">
    <div class="_form_element _x75754058 _full_width _clear" >
      <div class="_form-title">
        <?=esc_html($title)?>
      </div>
    </div>
    <div class="_form_element _x41812516 _full_width _clear" >
      <div class="_html-code"></div>
    </div>
    <div class="_form_element _x14808566 _full_width " >
      <label class="_form-label"></label>
      <div class="_field-wrapper">
        <input type="text" name="firstname" placeholder="First Name" required/>
      </div>
    </div>
    <div class="_form_element _x98398255 _full_width " >
      <label class="_form-label"></label>
      <div class="_field-wrapper">
        <input type="text" name="lastname" placeholder="Last Name" required/>
      </div>
    </div>
    <div class="_form_element _x58032742 _full_width " >
      <label class="_form-label"></label>
      <div class="_field-wrapper">
      ...
      <div class="_form_element _field7 _full_width " >
          ...
          <div class="_row _checkbox-radio">
              <input id="field_7By checking this box you confirm that you have read and agree to our privacy policy." type="checkbox" name="field[7][]" value="By checking this box you confirm that you have read and agree to our privacy policy."   required>
              <span>
                  <label for="field_7By checking this box you confirm that you have read and agree to our privacy policy.">
                    By checking this box you confirm that you have read and agree to our privacy policy.*
                  </label>
                </span>
          </div>
      </div>
      <div class="_form_element _x55349642 _full_width _clear" >
          <div class="_html-code">
              <a href="https://hellomaas.com/privacy-policy"><u>
                      Privacy Policy
                  </u>
              </a>
          </div>
...
(function() {
  ...
  var form_submit = function(e) {
    ...
    if (validate_form()) {
      ...
      _load_script('https://hellomaas.activehosted.com/proc.php?' + serialized + '&jsonp=true');
    }
    return false;
  };
